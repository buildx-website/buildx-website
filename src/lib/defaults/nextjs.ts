export const baseNextPrompt = `<boltArtifact id="project-import" title="NextJS 14 Project Files"><boltAction type="file" filePath=".eslintrc.json">{
...
<boltAction type="file" filePath="src/app/page.tsx">export default function Home() {
  return (
